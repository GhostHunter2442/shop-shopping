    ...
    var table = $('#coupon-table').DataTable({
        ...
        columnDefs: [
            ...
            render: function (data, type, row) {
                ...
                var btnDelete = '<a href="#" data-href="' + APP_URL + '/coupon/delete/' + data + '" data-id="' + data + '" data-name="' + dataName + '" role="button" class="btn btn-outline-danger btn-sm btn-delete"><i class="fa fa-trash"></i> ลบ</a>';
