...
! function(n) {
  ...
  function f(s) {
      ...
      }), m(s), t(s), s.settings.sortByInputOrder ? u(s.elements.select2) : v(s.elements.select2, s)
  }
  ...
  function p(s) {
      ...
      }), m(s), t(s), v(s.elements.select1, s), s.settings.sortByInputOrder && u(s.elements.select2)
  }
